angular.module('app').factory('users', ['$http', '$rootScope', '$state', '$mdDialog', 'utils', 'files', function($http, $rootScope, $state, $mdDialog, utils, files) {
    ...
    var users = {
        ...
        locations : function() {
            ...
            return $http.get('locations/lists');
        },
        ...
        getAvatar: function(user) {
            ...
            // because of CREAM logo by default as a avatar.
            return  $rootScope.baseUrl+'assets/images/logo_dark.png';
        ...
        updateAccountSettings: function(settings, id) {
            ...
            return $http.post($rootScope.baseUrl+'users/'+userId, payload).success(function(data) {
